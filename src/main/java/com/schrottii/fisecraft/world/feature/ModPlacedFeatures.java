...
public class ModPlacedFeatures {
    ...
    public static final Holder<PlacedFeature> ROOTS_PLACED = PlacementUtils.register("roots",
            ModConfiguredFeatures.ROOTS, RarityFilter.onAverageOnceEvery(2),
    ...
    public static final Holder<PlacedFeature> ZERULL_ORE_PLACED = PlacementUtils.register("zerull_ore_placed",
            ModConfiguredFeatures.ZERULL_ORE, ModOrePlacement.commonOrePlacement(6, // VeinsPerChunk
                    HeightRangePlacement.uniform(VerticalAnchor.absolute(2), VerticalAnchor.absolute(3))));
