...
public class ModConfiguredFeatures {
    ...
    public static final Holder<PlacedFeature> ROOTS_DUMMY_PLACED =
            PlacementUtils.register("roots_dummy_placed",
                    ROOTS_DUMMY_FEATURE,
                    java.util.List.of()//PlacementUtils.HEIGHTMAP
            );
    ...
    public static final Holder<ConfiguredFeature<VegetationPatchConfiguration, ?>> BLOCK_OF_ROOTS2 =
            FeatureUtils.register("block_of_roots2", Feature.VEGETATION_PATCH,
                    new VegetationPatchConfiguration(BlockTags.DEEPSLATE_ORE_REPLACEABLES, BlockStateProvider.simple(ModBlocks.BLOCK_OF_ROOTS.get()), ROOTS_DUMMY_PLACED, CaveSurface.FLOOR, ConstantInt.of(2), 0, 1, 0.5F, UniformInt.of(4, 8), 0.6F));
